...
<main class="container py-4">
    ...
    <div class="pb_headliners d-md-flex mx-auto align-items-center justify-content-between flex-wrap">
        ...
        <?php $logo_array = getMiniAndNormalImage('logo',$band->ID);?>
        <article class="single_band mb-5 mb-md-2" style="padding-bottom: <?php echo $logo_array['padding-bottom'];?>">
    ...
    <div class="pb_normals d-flex mx-auto align-items-center justify-content-center flex-wrap">
        ...
        <?php $logo_array = getMiniAndNormalImage('logo',$band->ID);?>
        <article class="single_band mb-5 mx-md-2 mx-xl-3 my-md-2"  style="padding-bottom: <?php echo $logo_array['padding-bottom'];?>">
